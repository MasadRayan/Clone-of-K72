            ...
            <div ref={fullNavLinksRef} className='relative'>
                ...
                <div className=' py-36'>
                    <div className='link origin-top relative border-t-1 border-white'>
                        <h1 className='font-[font2] text-8xl lg:text-[8vw] text-center lg:leading-[0.8] lg:pt-10 pt-3 uppercase'>Work</h1>
                        <div className='moveLink absolute text-black flex top-0 bg-[#D3FD50]'>
                            <div className='moveX flex gap-5 items-center'>
                                <h2 className='whitespace-nowrap font-[font2] lg:text-[8vw] text-8xl  text-center lg:leading-[0.8] lg:pt-10 pt-4 uppercase'>See Everything</h2>
                    ...
                    <div className='link origin-top relative border-t-1 border-white'>
                        <h1 className='font-[font2] text-8xl lg:text-[8vw] text-center lg:leading-[0.8] lg:pt-10 pt-3 uppercase'>Agence</h1>
                        <div className='moveLink absolute text-black flex top-0 bg-[#D3FD50] '>
                            <div className='moveX flex gap-5 items-center'>
                                <h2 className='whitespace-nowrap font-[font2] lg:text-[8vw] text-8xl  text-center lg:leading-[0.8] lg:pt-10 pt-4 uppercase'>Know us</h2>
                                <img className='lg:h-36 h-14 rounded-full shrink-0 lg:w-96 w-32 object-cover' src="https://k72.ca/uploads/caseStudies/WIDESCAPE/WS---K72.ca---MenuThumbnail-640x290.jpg" alt="" />
                                <h2 className='whitespace-nowrap font-[font2] lg:text-[8vw] text-8xl  text-center lg:leading-[0.8] lg:pt-10 pt-4 uppercase'>Know us</h2>
                                <img className='lg:h-36 h-14 rounded-full shrink-0 lg:w-96 w-32 object-cover' src="https://k72.ca/uploads/caseStudies/PJC/Thumbnails/PJC_SiteK72_Thumbnail_640x290-640x290.jpg" alt="" />
                            </div>
                    ...
                    <div className='link origin-top relative border-t-1 border-white'>
                        <h1 className='font-[font2] text-8xl lg:text-[8vw] text-center lg:leading-[0.8] lg:pt-10 pt-3 uppercase'>Contact</h1>
                        <div className='moveLink absolute text-black flex top-0 bg-[#D3FD50]'>
                            <div className='moveX flex gap-5 items-center'>
                                <h2 className='whitespace-nowrap font-[font2] lg:text-[8vw] text-8xl  text-center lg:leading-[0.8] lg:pt-10 pt-4 uppercase'>Send us a fax</h2>
                                <img className='lg:h-36 h-14 rounded-full shrink-0 lg:w-96 w-32 object-cover' src="https://k72.ca/uploads/caseStudies/WIDESCAPE/WS---K72.ca---MenuThumbnail-640x290.jpg" alt="" />
                                <h2 className='whitespace-nowrap font-[font2] lg:text-[8vw] text-8xl  text-center lg:leading-[0.8] lg:pt-10 pt-4 uppercase'>Send us a fax</h2>
                                <img className='lg:h-36 h-14 rounded-full shrink-0 lg:w-96 w-32 object-cover' src="https://k72.ca/uploads/caseStudies/PJC/Thumbnails/PJC_SiteK72_Thumbnail_640x290-640x290.jpg" alt="" />
                            </div>
                    ...
                    <div className='link origin-top relative border-y-1 border-white'>
                        <h1 className='font-[font2] text-8xl lg:text-[8vw] text-center lg:leading-[0.8] lg:pt-10 pt-3 uppercase'>Blogs</h1>
                        <div className='moveLink absolute text-black flex top-0 bg-[#D3FD50]'>
                            <div className='moveX flex gap-5 items-center'>
                                <h2 className='whitespace-nowrap font-[font2] lg:text-[8vw] text-8xl  text-center lg:leading-[0.8] lg:pt-10 pt-4 uppercase'>Read articles</h2>
                                <img className='lg:h-36 h-14 rounded-full shrink-0 lg:w-96 w-32 object-cover' src="https://k72.ca/uploads/caseStudies/WIDESCAPE/WS---K72.ca---MenuThumbnail-640x290.jpg" alt="" />
                                <h2 className='whitespace-nowrap font-[font2] lg:text-[8vw] text-8xl  text-center lg:leading-[0.8] lg:pt-10 pt-4 uppercase'>Read articles</h2>
                                <img className='lg:h-36 h-14 rounded-full shrink-0 lg:w-96 w-32 object-cover' src="https://k72.ca/uploads/caseStudies/PJC/Thumbnails/PJC_SiteK72_Thumbnail_640x290-640x290.jpg" alt="" />
                            </div>
