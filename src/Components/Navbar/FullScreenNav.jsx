...
const FullScreenNav = () => {
   ...
   function gsapAnimation() {
    ...
    return (
        <div ref={fullScreenRef} className='fullscreennav hidden text-white h-screen overflow-x-hidden w-full absolute top-0 left-0  z-50 flex flex-col justify-center'>
            ...
            <div>
                ...
                <div ref={fullNavLinksRef} className="w-full pt-20 ">
                    {/* WORK */}
